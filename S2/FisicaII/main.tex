...
\begin{document}
  ...
  \section*{Campo eléctrico}
    ...
    \subsection*{Fuerza ejercida sobre una partícula con carga $q$ colocada en un campo eléctrico}
      ...
      \end{equation*}
    \addcontentsline{toc}{subsection}{Fuerzas sobre una carga de pruebas según la ley de Coulomb}
    ...
    \addcontentsline{toc}{subsection}{Campo eléctrico debido a un número finito de cargas puntuales}
    \subsection*{Campo eléctrico debido a un número finito de cargas puntuales}
      ...
      \end{equation*}
    \addcontentsline{toc}{subsection}{Campo eléctrico debido a una distribución de carga continua}
